    ...
    return (<div className={'w-screen h-screen flex items-center justify-center bg-bg-primary'}>
            {loading ?
                ...
                <div className={'border-[1px] border-bd-primary border-solid p-8 rounded-2xl bg-bg-secondary'}>
                    ...
                    <form onSubmit={handleSubmit}  className={'w-full h-full flex flex-col items-center gap-2 justify-center '} >
                        <input
                        ...
                        />
                        <button type="submit" className="py-2 px-4 bg-btn-primary hover:bg-blue-700 focus:ring-blue-500 text-txt-primary w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">Login</button>
                    </form>
                </div>
            }
        </div>
